...
func main() {
	...
	for {
		...
		smtp.SendMail(host+":"+port, auth, "no-reply@email.com", []string{message["ambassador_email"].(string)}, ambassadorMessage) // TODO: instead of 172.17.0.1 could be host.docker.internal
